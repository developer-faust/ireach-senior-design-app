...
namespace DeviceMotion.Plugin
{
    ...
    /// </summary>
    public class DeviceMotionImplementation : Object, ISensorEventListener, IDeviceMotion
    {
        private readonly SensorManager sensorManager;
        private readonly Sensor sensorAccelerometer;
        private readonly Sensor sensorGyroscope;
        private readonly Sensor sensorMagnetometer;
        private readonly Sensor sensorCompass;
        private readonly Sensor sensorStepCounter;

        private readonly IDictionary<MotionSensorType, bool> sensorStatus;
            ...
            switch (e.Sensor.Type)
            {
                ...
                case SensorType.StepCounter:
                    SensorValueChanged(this,
                        ...
                        {
                            ValueType = MotionSensorValueType.Single,
                            SensorType = MotionSensorType.StepCounter,
                            Value = new MotionValue { Value = e.Values[0] }
                        });
                    break;
            }
